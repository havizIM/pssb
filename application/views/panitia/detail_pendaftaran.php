                                    ...
                                    <div class="row no-gutters gallerys ovrflow2">
                                        <div class="col-xl-12 col-lg-12">
                                         ...
                                         <div class="col-xl-4 col-lg-12">
                                            <div class="card text-center">
                                                <div class="card-content">
                                               <a href="<?= base_url() ?>doc/ijazah/${data.dokumen.ijazah}" target="_blank" class="magni"><img src="<?= base_url() ?>doc/ijazah/${data.dokumen.ijazah}" onerror="this.onerror=null;this.src='<?= base_url() ?>assets/img/error/undraw_problem_solving_ft81.svg';" style="width: 100%;border-left: 3px solid #1e9ff2;" class="img-fluid h-680 img-responsive"></a> 
                                                <div class="card-body">
