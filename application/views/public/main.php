...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets') ?>/app-assets/fonts/meteocons/style.css">
    <!-- END VENDOR CSS-->
    <!-- BEGIN MODERN CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets') ?>/app-assets/css/plugins/forms/checkboxes-radios.css">
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets') ?>/css/style.css">
     <link rel="stylesheet" type="text/css" href="<?= base_url('assets') ?>/app-assets/css/plugins/forms/wizard.css">
    <!-- END Custom CSS-->
  </head>
  <body class="horizontal-layout horizontal-menu 2-columns   menu-expanded" data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
                ...
                <ul class="mega-dropdown-menu dropdown-menu row">
                  <li class="col-md-2">
                    ...
                    <div id="mega-menu-carousel-example">
                      <div>
                        <img class="rounded img-fluid mb-1" src="<?= base_url('assets') ?>/app-assets/images/slider/slider-2.png"
    ...
    <script src="<?= base_url('assets') ?>/app-assets/js/vendors.min.js" type="text/javascript"></script>
    <script src="<?= base_url('assets') ?>/app-assets/js/owl.carousel.min.js" type="text/javascript"></script>
    <!-- BEGIN VENDOR JS-->
    <!-- BEGIN PAGE VENDOR JS-->
    <script type="text/javascript" src="<?= base_url('assets') ?>/app-assets/vendors/js/ui/jquery.sticky.js"></script>
    <script src="<?= base_url('assets') ?>/app-assets/vendors/js/timeline/horizontal-timeline.js" type="text/javascript"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN MODERN JS-->
    ...
    <script src="<?= base_url('assets/app-assets/vendors/js/sweetalert/sweetalert.min.js') ?>"></script>
     ...
     <script src="<?= base_url('assets') ?>/app-assets/vendors/js/forms/validation/jquery.validate.min.js" type="text/javascript"></script>

      <script src="<?= base_url('assets') ?>/app-assets/vendors/js/extensions/jquery.steps.min.js" type="text/javascript"></script>
